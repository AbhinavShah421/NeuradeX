...
| `backend` | `autopilot-service:8015` | `GET`/`POST` | `/status`, `/control` | [ai_engine.py](https://github.com/AbhinavShah421/NeuradeX/blob/main/backend/app/api/ai_engine.py) | — | Proxy autopilot status + enable/disable a mode |
