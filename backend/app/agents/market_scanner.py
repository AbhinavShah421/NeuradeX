...
FNO_STOCKS: set[str] = {
    ...
    "TMCV", "TMPV", "MARUTI", "SUNPHARMA", "DRREDDY", "CIPLA", "DIVISLAB",
    ...
    "APOLLOHOSP", "UPL", "TATACONSUM", "HCLTECH", "BHARTIARTL",
    ...
    "ETERNAL", "ADANIGREEN", "ADANIPOWER", "AUROPHARMA", "BIOCON",
    ...
    "LAURUSLABS", "GRANULES", "IPCALAB", "ALKEM",
